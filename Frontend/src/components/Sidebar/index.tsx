        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <NavLink
                to="/paybill"
                className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('form-layout') && 'bg-graydark dark:bg-meta-4'
                  }`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <NavLink
                  to="/history"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('history') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/editprofile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('editprofile') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
                    className="fill-current"
              ...
              {userRole === 'admin' && (
                <li>
                  ...
                  >
                    ...
                    >
                      <path
                        d="M15.4344 7.74075L15.9181 4.6435L13.15 3.978C12.7372 3.83175 12.4431 3.48075 12.4431 3.04575V2.29575C12.4431 1.4895 11.7776 0.823975 10.9714 0.823975H7.08445C6.2782 0.823975 5.6127 1.4895 5.6127 2.29575V3.018C5.6127 3.453 5.31857 3.804 4.90582 3.95025L2.10895 4.6435L2.5927 7.74075C2.66395 8.1535 2.4977 8.56625 2.1377 8.80025L0.0589548 10.2405L2.1377 11.6807C2.4977 11.9147 2.66395 12.3275 2.5927 12.7402L2.10895 15.8375L4.87607 16.503C5.28882 16.6492 5.58295 17.0002 5.58295 17.4352V18.1852C5.58295 18.9915 6.24845 19.657 7.0547 19.657H10.9416C11.7478 19.657 12.4133 18.9915 12.4133 18.1852V17.463C12.4133 17.028 12.7074 16.677 13.1202 16.5307L15.8873 15.8652L15.4036 12.7679C15.3323 12.3552 15.4986 11.9424 15.8586 11.7084L17.9373 10.2682L15.8586 8.82795C15.4986 8.59395 15.3323 8.1812 15.4036 7.76845L15.4344 7.74075Z"
                        fill=""
                      />
                    </svg>
                    Users
